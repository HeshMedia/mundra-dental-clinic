    ...
    <div className="w-full">
      ...
      <section className="flex flex-col md:flex-row justify-between items-center px-4 md:px-10 py-8 gap-8">
        ...
        <div className="md:w-1/2 flex flex-col md:items-start">
          ...
          <button className="bg-[#213f8e] text-white font-semibold px-6 py-3 rounded-3xl hover:bg-blue-600 transition-colors mt-8 md:mt-12 md:text-xl md:px-4 md:py-4 md:ml-10 w-[20vh] md:w-[27vh]">
            Book Appointment
          </button>
        </div>
        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative max-w-[500px] w-full">
            <img 
              className="w-full h-[340px] md:h-[500px] object-cover rounded-md border-4 hover:border-blue-500 border-gray-500 transition-all"
              src={homeheropic} 
